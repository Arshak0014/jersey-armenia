...
class TheSportsWear extends Component {
    ...
    showJerseys = (jerseys) => (
        jerseys ?
            jerseys.map((jersey) => (
                jersey.type === 'Sportswear' && jersey.ageLimit === 'Adult' && (jersey.gender === 'Male' || jersey.gender === "Unisex") ?
                    ...
                    { !this.state.loading ?
                        <div  className="container_the_shop">
                            ...
                            <div className="container_table">
                                {this.showJerseys(this.state.filterJerseys)}
                            </div>
